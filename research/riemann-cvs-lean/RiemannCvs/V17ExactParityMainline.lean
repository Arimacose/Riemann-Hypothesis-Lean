...
4. explicit compact-interval Dunster weight, mass, derivative, prolate slope,
   ...
   `c ≥ 33` weighted-cosine lower bound,
...
The source-specific Dunster remainder estimate instantiating the fixed-interval
Bessel bridge, its parameter threshold/phase identification, closed-form

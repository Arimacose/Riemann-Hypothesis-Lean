...
4. explicit compact-interval Dunster weight and mass bounds, prolate slope
   bounds, reduced-weight quotient control,
...
The source-specific reduced-weight derivative constant and Dunster remainder

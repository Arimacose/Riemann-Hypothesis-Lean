    ...
    *,
    ...
    return {
        ...
        "conditional_operator_inputs": [
            "the concrete Archimedean main diagonal satisfies the recorded pointwise lower bound and the pole, Archimedean-remainder, and prime parity forms satisfy the recorded absolute quadratic-form bounds",
        ],
        "git_sha": head,

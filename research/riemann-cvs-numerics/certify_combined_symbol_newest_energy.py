    ...
    *,
    ...
    return {
        ...
        "conditional_operator_inputs": [
            "the DLMF-form digamma norm remainder and real trigamma series floor hold on the tail, the single cutoff-13 endpoint scalar comparison holds at mode 960, and the Archimedean-remainder and prime parity forms satisfy the recorded absolute quadratic-form bounds",
        ],
        "git_sha": head,

    ...
    *,
    ...
    return {
        ...
        "conditional_operator_inputs": [
            "the concrete Archimedean main diagonal satisfies the recorded pointwise lower bound, the explicit even/odd pole weight-square sums satisfy the recorded poleTail scalar bound, and the Archimedean-remainder and prime parity forms satisfy the recorded absolute quadratic-form bounds",
        ],
        "git_sha": head,

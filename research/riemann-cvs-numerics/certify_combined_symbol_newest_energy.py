    ...
    *,
    ...
    return {
        ...
        "conditional_operator_inputs": [
            ...
            "the concrete dyadic index equivalences satisfy the vector-concatenation and old-core restriction hypotheses of finiteMatrixTowerEnergy_eq_recursiveBlockEnergy",
        ],
        "git_sha": head,

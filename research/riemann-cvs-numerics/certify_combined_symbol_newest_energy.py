    ...
    *,
    ...
    return {
        ...
        "conditional_operator_inputs": [
            "the concrete real digamma and trigamma terms satisfy the recorded pointwise lower bounds, and the Archimedean-remainder and prime parity forms satisfy the recorded absolute quadratic-form bounds",
        ],
        "git_sha": head,
